    ...
    public partial class IsrVariableMain : BaseForm
    {
        ...
        public IsrVariableMain()
        {
            ...
            filterByT1.FilterBy = (text) =>
            {
                ...
                {
                    dataGridView1.DataSource = new BindingList<IsrV>(_repository.FilterByValue(NumberEmployee));
                }
                else
                {
                    dataGridView1.DataSource = new BindingList<IsrV>(_repository.FilterByValue(text));
                }
            };
        }

        private void IsrVariableMain_Load(object sender, EventArgs e)
        {
        ...
        {
            var listIsr = _repository.GetIsrVs();
            Util.ConfigGrid<IsrV>(dataGridView1);
            dataGridView1.DataSource = new BindingList<IsrV>(listIsr);
        }
        ...
        private void parametersEdit()
        {
            ...
            var isr = new IsrVariableShow(this);
            isr.Id = Id;
            isr.Edit = true;
            isr.ShowDialog();
        }
        ...
        private void kitForm1_MDelete(object sender, EventArgs e)
        {
            ...
            if (ress == DialogResult.Yes)
            {
                ...
                var deleteCs = _repository.DeleteIsrV(Id);
